...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- Reset Modal -->
            <div class="modal fade" id="resetModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    $(document).ready(function() {
        $("#accounts_table").DataTable({
            ...
            ajax: {
                type: 'post',
                url: '<?= site_url('useraccounts/fetchAllLycean/faculty') ?>',
        ...
        $("#facultyAccountNav > a").addClass('active');
