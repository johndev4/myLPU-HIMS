                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="row" style="border:1px solid none">
                                        <div class="col-12">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <form action="<?= site_url('records/uploadStaffRecord') ?>" method="post" enctype="multipart/form-data">
...
<script>
    ...
    $(document).ready(function() {
        $("#records_table").DataTable({
            ...
            ajax: {
                type: 'post',
                url: '<?= site_url('records/fetchAllStaff') ?>',
                data: {
        ...
        $("#staffRecordNav > a").addClass('active');
    ...
    function setDeleteActionForm(id) {
        $('#deleteModalForm').prop('action', '<?= site_url('records/deleteStaffRecord') ?>/' + id);
    }
    ...
    function constructModifyModal(id, obj = {
        ...
        $('#modifyModalForm').prop('action', '<?= site_url('records/modifyStaffData') ?>/' + id);
        if (obj['error'] == false) {
