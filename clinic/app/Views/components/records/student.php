                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row" style="border:1px solid none">
                                            <div class="col-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <form action="<?= site_url('records/uploadStudentRecord') ?>" method="post" enctype="multipart/form-data">
    ...
    <script>
        setTimeout(function() {
            <?php if (session()->get('success') !== null) : ?>
                ...
                // Re-show view modal with data after upload and delete medical records, and modify informations
        ...
        function setDeleteActionForm(id) {
            $('#deleteModalForm').prop('action', '<?= site_url('records/deleteStudentRecord') ?>/' + id);
        }
        ...
        function constructModifyModal(id, obj = {
            ...
            $('#modifyModalForm').prop('action', '<?= site_url('records/modifyStudentInformation') ?>/' + id);
            if (obj['error'] == false) {
