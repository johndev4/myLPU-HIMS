...
class Mentalwellness extends BaseController
{
    ...
    // SEND CONSULTATION REQUEST TO GUIDANCE COUNSELOR
    // -----------------------------------------------------------------
                ...
                if (!hasActive() && !hasPending()) {
                    ...
                    if ($success1 && $success2) {
                        ...
                        createLog(
                            ...
                            "User \"" . getIdNo() . "\" sent a consultation request to guidance counselor \"{$data['personnel_id_no']}\" with consultation_no: \"{$data['consultation_no']}\""
                        );
                    } else {
                    }
                } else {
